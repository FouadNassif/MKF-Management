...
@section('content')
    ...
    @auth
        <div class="flex flex-col w-full justify-center items-center">
            ...
            <div class="w-full">
                <form action="/updateProfile" method="post" class="w-full flex flex-col justify-center items-center">
                    @csrf
                    ...
                    <div class="mt-5 w-3/4">
                        ...
                        @error('address')
                            <span class="text-red-600 font-bold ml-5">*{{ $message }}</span>
                        @enderror
                        <input type="text" id="name" name="address" value="rachiine zgharta"
                            class="w-full bg-transparent outline-0 cursor-pointer mt-4 border-2 rounded-xl border-Primary p-2">
                    </div>
